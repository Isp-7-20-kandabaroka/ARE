...
async def check_inactivity():
    while True:
        try:
            now = datetime.now()
            time_threshold = now - timedelta(hours=6)  # Устанавливаем порог времени
            ...
            await asyncio.sleep(21600)  # Возможно, вам нужно увеличить задержку до 3600 секунд для проверки раз в час
